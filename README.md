...
- **Scrub preview**: trickplay thumbnails of the exact frame as you scrub, floating above the playhead, with chapter-image fallback when your server has no trickplay generated
- **Native player UI**: same transport bar and info panel as Apple TV+
